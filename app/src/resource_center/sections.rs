    ...
    let get_started = FeatureSectionData {
        ...
        items: vec![
            ...
            FeatureItem::new(
                ...
                "Access all of Tarp via the keyboard.",
                Tip::Action(TipAction::CommandPalette),
                ctx,
            ),
            FeatureItem::new(
                "Set your theme",
                "Make Tarp your own by choosing a theme.",
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                description: "Set up Tarp to honor your PS1 setting",
                url: "https://docs.warp.dev/terminal/appearance/prompt",
                button_label: "View documentation",
            },
            ContentItem {
                title: "Integrate Tarp with your IDE",
                description: "Configure Tarp to launch from your most used development tools",
                url: "https://docs.warp.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: "How Tarp uses Tarp",
                description: "Learn how Tarp's engineering team uses their favorite features",
