...
impl Display for SettingsSection {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            SettingsSection::WarpDrive => write!(f, "Tarp Drive"),
            SettingsSection::WarpAgent => write!(f, "Tarp Agent"),
            ...
            SettingsSection::Warpify => write!(f, "Tarpify"),
            _ => write!(f, "{self:?}"),
        }
    }
}
...
impl FromStr for SettingsSection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "Teams" => Ok(Self::Teams),
            "Warpify" | "Tarpify" => Ok(Self::Warpify),
            "WarpDrive" | "Warp Drive" | "Tarp Drive" => Ok(Self::WarpDrive),
            // This page was called "Oz" at one point, keep for backward compatibility.
            "Oz" | "Warp Agent" | "Tarp Agent" => Ok(Self::WarpAgent),
...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        // Build sidebar nav items. Tarp is a plain terminal: the Account,
        // Agents (AI), Cloud platform, Teams, Referrals, Warpify, and Warp Drive
