...
const TELEMETRY_TITLE: &str = "Help improve Tarp";
...
const TELEMETRY_DOCS_URL: &str = "https://github.com/ramsrib/tarp";
...
const PRIVACY_POLICY_LINK_TEXT: &str = "Read Tarp's privacy policy";
    ...
    fn render(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        "Read more about Tarp's use of data".into(),
