...
const HEADER_TEXT: &str = "Invite a friend to Tarp";
const ANONYMOUS_USER_HEADER_TEXT: &str = "Sign up to participate in Tarp's referral program";
...
const REWARD_INTRO: &str = "Get exclusive Tarp goodies when you refer someone*";
