...
impl CliAgentPluginManager for ClaudeCodePluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Tarp plugin installed. Please run /reload-plugins to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Tarp plugin updated. Please run /reload-plugins to activate."
    }
...
static INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Install Tarp Plugin for Claude Code",
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| PluginInstructions {
    title: "Update Tarp Plugin for Claude Code",
