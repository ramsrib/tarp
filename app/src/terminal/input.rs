...
const AGENT_MODE_HINT_OPTIONS: &[&str] = &[
    "Tarp anything e.g. Deploy my React app to Vercel and set up environment variables",
    "Tarp anything e.g. Help me debug why my Python tests are failing in CI",
    "Tarp anything e.g. Set up a new microservice with Docker and create the deployment pipeline",
    "Tarp anything e.g. Find and fix the memory leak in my Node.js application",
    "Tarp anything e.g. Create a backup script for my PostgreSQL database and schedule it",
    "Tarp anything e.g. Help me migrate my data from MySQL to PostgreSQL",
    "Tarp anything e.g. Set up monitoring and alerts for my AWS infrastructure",
    "Tarp anything e.g. Build a REST API for my mobile app using FastAPI",
    "Tarp anything e.g. Help me optimize my SQL queries that are running slowly",
    "Tarp anything e.g. Create a GitHub Actions workflow to automatically deploy on merge",
    "Tarp anything e.g. Set up Redis caching for my web application",
    "Tarp anything e.g. Help me troubleshoot why my Kubernetes pods keep crashing",
    "Tarp anything e.g. Build a data pipeline to process CSV files and load them into BigQuery",
    "Tarp anything e.g. Set up SSL certificates and configure HTTPS for my domain",
    "Tarp anything e.g. Help me refactor this legacy code to use modern design patterns",
    "Tarp anything e.g. Create unit tests for my authentication service",
    "Tarp anything e.g. Set up log aggregation with ELK stack for my distributed system",
    "Tarp anything e.g. Help me implement OAuth2 authentication in my Express.js app",
    "Tarp anything e.g. Optimize my Docker images to reduce build times and size",
    "Tarp anything e.g. Set up A/B testing infrastructure for my web application",
];
