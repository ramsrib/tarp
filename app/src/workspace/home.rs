...
const WARP_HOME_TITLE: &str = "Welcome to Tarp on Web";
const WARP_HOME_CONTENT: &str = r#"
Welcome to Tarp on Web - your browser-based home for Tarp!
Use Tarp on Web to:
* Join Shared Sessions
* Create, View, and Edit Tarp Drive Objects
* Manage your Tarp Settings

Tarp on Web can also be used by your teammates and peers who don't have Tarp downloaded yet to view your shared sessions, notebooks, and workflows."#;
