...
pub fn init(app: &mut AppContext) {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                EditableBinding::new(
                    ...
                    "[Debug] Install OpenCode Tarp plugin",
                    WorkspaceAction::InstallOpenCodeWarpPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_warp_plugin",
                    "[Debug] Use local OpenCode Tarp plugin (testing only)",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: Tarp Drive"),
        ...
        EditableBinding::new(
            TOGGLE_WARP_DRIVE_BINDING_NAME,
            BindingDescription::new("Toggle Tarp Drive")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Tarp Drive"),
            WorkspaceAction::ToggleWarpDrive,
        )
        .with_context_predicate(id!("Workspace") & id!(flags::ENABLE_WARP_DRIVE)),
        EditableBinding::new(
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Tarp"),
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: Tarpify")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "Configure Tarpify..."),
